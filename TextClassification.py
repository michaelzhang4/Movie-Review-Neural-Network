...
canvas.pack()
canvas.create_text(75, 25, text="RightArrow key: next review")
canvas.create_text(75, 50, text="Or r key: next review")
canvas.create_text(75, 75, text="e key to exit")
canvas.bind('<Right>', lambda e: on_key())
canvas.bind('<r>', lambda e: on_key())
canvas.bind('<e>', lambda e: exit())
canvas.pack()
canvas.focus_set()
root.mainloop()